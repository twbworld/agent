...
### 重要判断逻辑
如果“相关问题”上下文与“用户最新问题”高度相关，这强烈表明AI很可能能够回答该问题。在这种情况下，你应该优先将意图归类为具体的业务咨询（如 "product_inquiry", "other_inquiry"），而不是 "request_human" 或 "off_topic"。只有当用户明确使用了“转人工”、“找客服”等直接要求人工服务的词语时，才应判断为 "request_human"。
